...
import streamlit as st
import time
from ingest import ingest_document   # your ingestion logic
from rag import generate_answer      # your RAG + ollama logic
...
if uploaded_file:
    try:
        ingest_document(uploaded_file)  # direct call instead of API
        st.success("✅ Document uploaded and processed successfully!")
...
if user_input:
    ...
    try:
        answer = generate_answer(user_input, use_web)
    except Exception as e:
        answer = f"Error: {e}"
